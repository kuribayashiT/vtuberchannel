                    ...
                    GestureDetector(child: InkWell(
                      ...
                      child: Row(
                          children: [
                            ...
                            CircleAvatar(
                              radius: 12, // アイコンのサイズを調整
                              backgroundImage: NetworkImage(icons[category] ?? ''),
                              backgroundColor: Colors.grey.shade200, // デフォルト背景色
                            ...
                            Expanded( // テキスト部分を広げて、タップ領域を広く
                              child: Text(
                                category,
                                overflow: TextOverflow.ellipsis, // テキストが長すぎる場合の処理
                              ),
                            ),
                          ],
                        ),
